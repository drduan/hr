...
namespace ExifWorks
{
    ...
    public class ExifManager : IDisposable
    {
        ...
        public override string ToString()
        {
            ...
            SB.Append("\n Xp Info comment \t"+XPComment);
            SB.Append("\n Xp Info title \t" + XPTitle.Trim());
            SB.Append("\n Xp Info keyword \t" + XPKeywords.Trim());

            //+""this.XPKeywords+""+this.XPTitle
            //SB.Replace("\n", vbCrLf);
            //SB.Replace("\t", vbTab);
            return SB.ToString();
        }
        ...
        public string XPComment
        {
            ...
            set
            {
                try
                {
                    this.SetPropertyString((int)TagNames.XPComment, value);
                }
                catch { }
            }
        ...
        public string  XPTitle
        {
            get
            {
                return this.GetPropertyString((int)TagNames.XPTitle);
            }
            set
            {
                try
                {
                    this.SetPropertyString((int)TagNames.XPTitle, value);
                }
                catch { }
            }
        ...
        public string XPKeywords
        {
            get
            {
                return this.GetPropertyString((int)TagNames.XPKeywords);
            }
            set
            {
                try
                {
                    this.SetPropertyString((int)TagNames.XPKeywords, value);
                }
                catch { }
            }
